...
function generateIndex(dir) {
  ...
  const content = `
    ...
    *,*::before,*::after {box-sizing: border-box;color:white;}
    ...
    ul {width:100%;margin:0;padding:0;list-style:none;display:flex;align-items:center;justify-content:flex-start;flex-direction:column;}
    li {width:100%;height:auto;background:rgba(0,0,0,0.1);display:flex;align-items:center;justify-content:flex-start;flex-direction:row;padding:5px;padding-top:0;border-bottom:1px solid rgb(75,75,75);border-radius:5px;}
